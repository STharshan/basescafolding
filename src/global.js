export const siteConfig = {
  ...
  hero: {
    badge: "Base Scaffolding Services",
    title: {
      lineOne: "Safe & Reliable Scaffolding",
      lineTwo: "Solutions",
    },
    media: {
      type: "video",
    ...
    rating: {
      value: "5.0",
      label: "Based on Customer Reviews",
    },
  },
  ...
  services: {
    badge: "Our Services",
    heading: "Reliable scaffolding services for every project",
    ctaLabel: "Learn More",
    summary:
  ...
  contact: {
    badge: "Contact Us",
    heading: {
      lineOne: "We're ready to build",
      lineTwo: "your future together",
    },
    description:
      "We partner with you to plan, design, and deliver high-quality construction projects with transparency, expertise, and a commitment to long-term value.",
    email: "info@domainname.com",
    phone: "07739583704",
    addressLabel: "Address:",
    address: "34 Brierley Rd W, Swinton, Manchester M27 9TP",
    socialLinks: [
  ...
  footer: {
    ...
    officeEmail: "office.co.uk",
    officePhone: "07739583704",
    linksTitle: "Links",
    socialTitle: "Get In Touch",
    brandName: "Base Scaffolding",
    copyrightYear: "2026",
